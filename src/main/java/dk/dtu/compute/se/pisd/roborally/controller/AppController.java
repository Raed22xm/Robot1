...
public class AppController implements Observer {
    ...
    public void newGame() {
        // Step 1: Ask user for number of players
        ...
        if (result.isPresent()) {
            if (gameController != null) {
                // Ask user if they want to stop the current game
                if (!stopGame()) {
                    return;
                }
            }

            // Step 2: Ask user for board selection
